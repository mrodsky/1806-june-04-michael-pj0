(function () {
  ...
  button1.addEventListener('click', () => {
    ...
    document.querySelector("div[name='price1']").innerHTML = temp;
  })
  // end of button 1 
  ...
  button2.addEventListener('click', () => {
    ...
    document.querySelector("div[name='price2']").innerHTML = temp;
  })
  //end of button 2
  ...
  button3.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price3']").innerHTML = temp;
  })
  //end button 3
  ...
  button4.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price4']").innerHTML = temp;
  })
  //end of button 4
  ...
  button5.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price5']").innerHTML = temp;
  })
  //end of button 5
  ...
  button6.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price6']").innerHTML = temp;
  })
  //end of button 6
  ...
  button7.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price7']").innerHTML = temp;
  })
  //end of button 7
  ...
  button8.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price8']").innerHTML = temp;
  })
  //end of button 8
  ...
  button9.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price9']").innerHTML = temp;
  })
  //end of button 9
  ...
  button10.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price10']").innerHTML = temp;
  })
  ...
  button11.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price11']").innerHTML = temp;
  })
  //end of button 11
  ...
  button12.addEventListener('click', () => {
    ...
    console.log('this is in add button: ' + priceHTML + " " + temp);
    document.querySelector("div[name='price12']").innerHTML = temp;
  })
}());
//end of button 12
